...
// Es requisito que cada frase esté en un print diferente en una línea diferente
// El resultado debe quedar en que la frase se pueda leer en una sola línea
public class EjercicioPrint03 {
	// Declara el método main
		...
		// Dentro del método main imprime la segunda frase
	
		// ¿El resultado es en una línea?
