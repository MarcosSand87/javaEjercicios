...
public class C_Metodos {
    ...
    public static void main(String[] args) {
        ...
        // Guarda en una variable llamada division el resultado de llamar al método
        // division()
        float division = division(a, b);
        // Que muestre por pantalla dicho resultado
        System.out.println(division);

        // Guarda en una variable llamada multiplicacion el resultado de llamar al
        // método multiplicacion()
        int multiplicacion = multiplicacion(a, b);
        // Que muestre por pantalla dicho resultado
        System.out.println(multiplicacion);

        // Guarda en una variable llamada resto el resultado de llamar al método
        // modulo()
        float resto = resto(a, b);
        // Que muestre por pantalla dicho resultado
        System.out.println(resto);

        // Cierra Scanner para evitar problemas (acostúmbrate a cerrarlo cuando deja de
        // ser necesario)
        sc.close();
     ...
     * Cada método llamado dentro de main, aunque se haya declarado después, va a
     * ejecutarlo.
     * 
     * ----METODOLOGIA----
     ...
     * Indica el nombre de cada método (suma, resta, division, multiplicacion,
     * modulo)
    ...
    private static float resto(int a, int b) {
        return a % b;
    }
